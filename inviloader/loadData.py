...
def main():
  ...
  #Place data
  def loadPlace():
    placeFile = open(path+"place.csv", "r")
  ...
  def updateCountry():
    placeFile = open(path+"place_isPartOf_place.csv", "r")
    places = csv.reader(placeFile, delimiter="|")
    conn = connectToDB()
    cur = conn.cursor()
    places.next() #ignore the first line of the CSV
  ...
  def updateCity():
   ...
   #Person data
  def loadPerson():
    placeFile = open(path+"person.csv", "r")
  ...
  def updatePerson():
    emailFile = open(path+"person_email_emailaddress.csv", "r")
    emails = csv.reader(emailFile, delimiter="|")
    isLocatedInFile = open(path+"person_isLocatedIn_place.csv", "r")
    locations = csv.reader(isLocatedInFile, delimiter="|")
    languageFile = open(path+"person_speaks_language.csv", "r")
  ...
  #Message data
  def loadMessage():
    placeFile = open(path+"comment.csv", "r")
  ...
  def updateMessage():
    hasCreatorFile = open(path+"comment_hasCreator_person.csv", "r")
    creators = csv.reader(hasCreatorFile, delimiter="|")
    isLocatedInFile = open(path+"comment_isLocatedIn_place.csv", "r")
    locations = csv.reader(isLocatedInFile, delimiter="|")
    conn = connectToDB()
    cur = conn.cursor()
    ...
    #Comment data
  def loadComment():
    dataFile = open(path+"comment.csv", "r")
  ...
  def updateComment():
    dataFile = open(path+"comment_replyOf_comment.csv", "r")
    comments= csv.reader(dataFile, delimiter="|")
    conn = connectToDB()
    cur = conn.cursor()
    comments.next() #ignore the first line of the CSV
  ...
  def loadTagClass():
    tagClassFile = open(path+"tagclass.csv", "r")
  ...
  def updateTagClass():
    subClassTagFile = open(path+"tagclass_isSubclassOf_tagclass.csv", "r")
  ...
  def loadOrganization():
    organisationFile = open(path+"organisation.csv", "r")
  ...
  def updateOrganization():
    organisationFile = open(path+"organisation_isLocatedIn_place.csv", "r")
    organisations = csv.reader(organisationFile, delimiter="|")
    conn = connectToDB()
    cur = conn.cursor()
    organisations.next() #ignore the first line of the CSV
  ...
  def updatePost():
    containerFile = open(path+"forum_containerOf_post.csv", "r")
  ...
  def loadForum():
    forumFile = open(path+"forum.csv", "r")
  ...
  def loadKnows():
    personKnowsFile = open(path+"person_knows_person.csv", "r")
  ...
  def loadLikes():
    personLikesFile = open(path+"person_likes_post.csv", "r")
  ...
  def loadHasInterest():
    interestFile = open(path+"person_hasInterest_tag.csv", "r")
  ...
  def loadWorkAt():
    workAtFile = open(path+"person_workAt_organisation.csv", "r")
  ...
  def loadStudyAt():
    studyAtFile = open(path+"person_workAt_organisation.csv", "r")
  ...
  def loadForumHasTag():
    tagFile = open(path+"forum_hasTag_tag.csv", "r")
    tags = csv.reader(tagFile, delimiter="|")
    conn = connectToDB()
    cur = conn.cursor()
    tags.next() #ignore the first line of the CSV
  ...
  def loadHasMember():
    memberFile = open(path+"forum_hasMember_person.csv", "r")
  ...
  def loadPostHasTag():
    tagFile = open(path+"post_hasTag_tag.csv", "r")
    tags = csv.reader(tagFile, delimiter="|")
    conn = connectToDB()
    cur = conn.cursor()
    tags.next() #ignore the first line of the CSV
  ...
  def loadHasType():
    typeFile = open(path+"tag_hasType_tagclass.csv", "r")
